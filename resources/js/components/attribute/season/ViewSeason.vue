                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 d-flex justify-content-between">
                            <h4>Season</h4>
                            <button class="btn btn-primary mb-2 mr-3" v-if="showPermission.includes('attribute-create')" data-toggle="modal" data-target="#seasonModal" @click="formReset">Add New</button>
                        </div>                          
                    </div>
                </div>       
                                ...
                                <template v-for="(season,index) in seasons.data" :key="season.id">
                                    <tr>
                                        ...
                                        <td v-if="showPermission.includes('attribute-edit') || showPermission.includes('attribute-delete')">
                                            <button type="button" v-if="showPermission.includes('attribute-edit')" class="btn btn-sm btn-info" data-toggle="modal" data-target="#seasonModal" @click="editSeason(season)">Edit</button>
                                            <button type="button" v-if="showPermission.includes('attribute-delete')" class="btn btn-sm btn-danger ml-2" @click="deleteSeason(season.id)">Delete</button>
                                        </td>
                                    </tr>					
                                </template>
                            </tbody>
                        ...
                        <div class="widget-content widget-content-area">
                            <form>
                                ...
                                <div class="modal-footer md-button">
                                    ...
                                    <button v-if="season_id == ''" type="button" class="btn btn-primary" @click="storeSeason">Submit</button>
