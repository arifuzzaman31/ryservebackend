                        ...
                        <table class="table table-bordered table-hover mb-4">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" v-if="showPermission.includes('edit-reservation')">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                    ...
                    <div class="widget-content-area">
                        <form @submit.prevent="createBooking()">
                            ...
                            <div class="col-6 mt-3">
                                ...
                                <input type="number" min="1" class="form-control form-control-sm" id="GuestNumber" v-model="bookingData.guestNumber" placeholder="Guest Number" required>
                            </div>
