<div class="sidebar-wrapper sidebar-theme">
    <nav id="sidebar" style="height: 92%;overflow-y: auto;">
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu @if(request()->is('admin/business')) active @endif" id="productMenu">
                <a href="{{ route('business') }}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu @if(request()->is('admin/asset')) active @endif" id="productMenu">
            ...
            <li class="menu @if(request()->is('admin/amenities')) active @endif" id="productMenu">
                <a href="{{ route('amenities') }}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu @if(request()->is('admin/employee')) active @endif" id="productMenu">
                <a href="{{ route('employee') }}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
